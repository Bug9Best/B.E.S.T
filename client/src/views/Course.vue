  ...
  methods: {
    ...
    enroll(id) {
      this.$confirm.require({
        ...
        accept: async () => {
          try {
             await axios.post(import.meta.env.VITE_ENDPOINT + '/api/enrollment/createEnroll', {
              courseId: id,
              userId: this.user.id
            })
    ...
    async createCourse() {
      try {
        await axios.post(import.meta.env.VITE_ENDPOINT + '/api/course/createCourse', this.formData)
        this.visible = false
    ...
    async getCourse() {
      try {
        const res = await axios.get(import.meta.env.VITE_ENDPOINT + '/api/course/getCourse')
